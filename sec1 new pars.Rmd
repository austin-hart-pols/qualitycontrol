...
We outline a framework for studying retrospective voting and present eleven experimental tests of its micro foundations. What do we expect to achieve? Testing and advancing theories of retrospective voting sheds light on the normative significance of one of the most widely-observed patterns of voting behavior. What do we learn about the possibility of retrospective accountability, for example, when we observe voters sanctioning an incumbent in the midst of a recession? The answer depends on the causal mechanisms at work. To the extent that the behavior reflects a haphazard, bias-prone, and/or naive reaction, retrospective voting is no cause for optimism.

Similarly, exploring the mechanisms of retrospective voting should offer insight into what it means when retrospective voting wanes. If voters fail to hold incumbents accountable for past performance, is it because they are incapable of managing the I/A task?
